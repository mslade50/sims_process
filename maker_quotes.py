...
Outright minimum edge is side-aware (price units): YES 0.5c, NO 0.3c. H2H
matchups are NOT handled here — they keep their own higher gate in scan_matchups.
"""
from __future__ import annotations

import quote_engine as qe

EDGE_YES = 0.005   # min edge required to bid YES
EDGE_NO = 0.003    # min edge required to bid NO
...
def plan_market(*, ticker, market_type, player, title, yes_bid, yes_ask, sim_yes,
    ...
    out = []
    for side, fair, edge, bid, ask, held, resting in chosen:
        ceiling = fair - edge
